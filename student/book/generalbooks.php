...
$where = "WHERE category='General Books'";
if ($filter === 'available') {
...
<head>
  <meta charset="UTF-8" />
  <title>General Books - Library System</title>
  ...
  <style>
    ...
    .banner {
      background-image: url('../../images/book categories/general.jpg');
...
<section class="banner">
  <div class="banner-overlay"><h1>General Books Collection</h1></div>
</section>
...
<div class="container my-4 text-center">
  <?= $feedback ?>
  <a href="generalbooks.php" class="btn btn-primary <?= $filter === 'all' ? 'active' : '' ?>">All</a>
  <a href="generalbooks.php?availability=available" class="btn btn-success <?= $filter === 'available' ? 'active' : '' ?>">✓ Available</a>
  <a href="generalbooks.php?availability=notavailable" class="btn btn-warning <?= $filter === 'notavailable' ? 'active' : '' ?>">✗ Not Available</a>
  <a href="generalbooks.php?availability=currently" class="btn btn-danger <?= $filter === 'currently' ? 'active' : '' ?>">Currently Unavailable</a>
</div>
