...
$where = "WHERE category='Magazines & Periodicals'";
if ($filter === 'available') {
...
<head>
  <meta charset="UTF-8" />
  <title>Magazines & Periodicals - Library System</title>
  ...
  <style>
    ...
    .banner {
      background-image: url('../../images/book categories/magazines.jpg');
...
<section class="banner">
  <div class="banner-overlay"><h1>Magazines & Periodicals</h1></div>
</section>
...
<div class="container my-4 text-center">
  <?= $feedback ?>
  <a href="magazinesandperiodicals.php" class="btn btn-primary <?= $filter === 'all' ? 'active' : '' ?>">All</a>
  <a href="magazinesandperiodicals.php?availability=available" class="btn btn-success <?= $filter === 'available' ? 'active' : '' ?>">✓ Available</a>
  <a href="magazinesandperiodicals.php?availability=notavailable" class="btn btn-warning <?= $filter === 'notavailable' ? 'active' : '' ?>">✗ Not Available</a>
  <a href="magazinesandperiodicals.php?availability=currently" class="btn btn-danger <?= $filter === 'currently' ? 'active' : '' ?>">Currently Unavailable</a>
</div>
