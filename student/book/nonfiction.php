...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'reserve') {
        ...
        if (mysqli_num_rows($alreadyBorrowed) > 0) {
            ...
            ");
            $feedback = "<div class='alert alert-success text-center'>Book reserved!</strong>.<br>Your dashboard will update when book is available.</div>";
        }
    }
}
...
$where = "WHERE category='Non-Fiction'";
if ($filter === 'available') {
...
<head>
  <meta charset="UTF-8">
  <title>Non-Fiction - Library System</title>
  ...
  <style>
    ...
    .banner {
      background-image: url('../../images/book categories/nonfiction.jpg');
...
<section class="banner">
  <div class="banner-overlay"><h1>Non-Fiction Collection</h1></div>
</section>
...
<div class="container my-4 text-center">
  <?= $feedback ?>
  <a href="nonfiction.php" class="btn btn-primary <?= $filter === 'all' ? 'active' : '' ?>">All</a>
  <a href="nonfiction.php?availability=available" class="btn btn-success <?= $filter === 'available' ? 'active' : '' ?>">✓ Available</a>
  <a href="nonfiction.php?availability=notavailable" class="btn btn-warning <?= $filter === 'notavailable' ? 'active' : '' ?>">✗ Not Available</a>
  <a href="nonfiction.php?availability=currently" class="btn btn-danger <?= $filter === 'currently' ? 'active' : '' ?>">Currently Unavailable</a>
</div>
