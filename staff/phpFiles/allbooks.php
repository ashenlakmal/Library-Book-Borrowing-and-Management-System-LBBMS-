<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
       ...
       $cntBorrow = mysqli_fetch_assoc(mysqli_query($connect, "SELECT COUNT(*) AS cnt FROM book_record WHERE student_id='$enrollment' AND return_date >= CURDATE() AND state='ACTIVE'"))['cnt'];
       $cntReserve = mysqli_fetch_assoc(mysqli_query($connect, "SELECT COUNT(*) AS cnt FROM reserve_record WHERE student_id='$enrollment' AND state='ACTIVE'"))['cnt'];
...
<div class="container my-4">
  <div class="d-flex justify-content-between">
    <a href="../managebook.php" class="btn btn-outline-primary">
