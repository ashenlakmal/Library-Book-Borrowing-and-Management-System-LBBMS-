...
if (isset($_SESSION['user'])) {
    ...
    if ($student) {
        ...
        if (!empty($photo)) {
            $cleanPath = str_replace("../../", "", $photo); // fix path from DB
...
<head>
  ...
  <title>Student Home - Library System</title>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link" href="borrowbook.php">Borrow Books</a></li>
